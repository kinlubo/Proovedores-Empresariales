...
public class BranchOfficeAllRestController {
    ...
    public BranchOfficeAllRestController(BranchOfficeCompanService branchOfficeCompanService, CompanyService companyService, CityService cityService) {
    ...
    {   BranchOfficeCompan branchOfficeCompan = null;
        ...
        { if(departament(departament_Name)==null)
            {
